...
export function AlphalistFrame({
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-white text-slate-900">
      <div className="pointer-events-none absolute left-5 top-5 z-30 flex items-center gap-2 sm:left-8 sm:top-7 sm:gap-3">
        <Image
        ...
        />
        <span className="text-[10px] uppercase tracking-[0.2em] text-slate-400 sm:text-[11px] sm:tracking-[0.25em]">
          / CTO Bootcamp
        </span>
      </div>

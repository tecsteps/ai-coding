        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-6 md:py-8 overflow-y-auto">
          <div className="w-full max-w-5xl">
            ...
            <BlurFade delay={0.2} duration={0.5}>
              <div className="mb-6 sm:mb-8 p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-950/30 to-slate-900/60">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="flex-shrink-0 flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-purple-500/20">
                    <Shield className="h-5 w-5 sm:h-5.5 sm:w-5.5 md:h-6 md:w-6 text-purple-400" />
                  </div>
                  <div>
                    <p className="text-[10px] sm:text-xs text-purple-400 uppercase tracking-wider mb-0.5 sm:mb-1">Tooling</p>
            ...
            <BlurFade delay={0.3} duration={0.5}>
              <ul className="mb-6 sm:mb-8 md:mb-10 space-y-2 sm:space-y-3 md:space-y-4">
                {slide.points.map((point, index) => (
                  <li key={index} className="flex items-start gap-2 sm:gap-3 text-sm sm:text-base md:text-lg text-slate-300">
                    <CheckCircle className="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 mt-0.5 text-purple-400" />
                    {point}
                  </li>
                ))}
              </ul>
            ...
            <BlurFade delay={0.4} duration={0.5}>
              <div>
                <p className="text-xs sm:text-sm text-slate-500 uppercase tracking-wider mb-3 sm:mb-4">
                ...
                {slide.bottomStatement && (
                  ...
                  >
                    <p className="text-base sm:text-lg md:text-xl font-medium text-purple-300 italic">
                      {slide.bottomStatement}
                    </p>
                  </div>
                )}
